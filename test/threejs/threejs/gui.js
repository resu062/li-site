...
let cortex;
export default class GlobalParams extends GUI {
    constructor(r) {
        super();
        this.maxDistDend = 20;
        this.maxProxDend = 20;
        ...
        this.maxDendSegs = 19;
        this.showDots = true;
        this.setCortex = (_cortex) => { cortex = _cortex; }
        this.add(this, "showDots")
            .onChange(function (value) {
                for (let k = 0; k < cortex.numLayers; ++k) {
        ...
        let prox = this.addFolder('Proximal');

        this.showProxDend = false;
        ...
        let dist = this.addFolder('Distal');

        this.showDistDend = false;
